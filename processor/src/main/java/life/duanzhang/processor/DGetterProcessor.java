...
public class DGetterProcessor extends AbstractProcessor {
...
//    }
    ...
    public Set<String> getSupportedAnnotationTypes() {
        ...
        set.add(DGetter.class.getCanonicalName());
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        Set<? extends Element> set = roundEnv.getElementsAnnotatedWith(DGetter.class);
    ...
    private JCTree.JCMethodDecl makeGetterMethodDecl(JCTree.JCVariableDecl jcVariableDecl) {
        ...
        return treeMaker.MethodDef(treeMaker.Modifiers(Flags.PUBLIC),//mods：访问标志
